...
import com.bxj.exception.CustomException;
...
public class OkHttpUtils {
    ...
    private static Request buildUrlEndConnetorParam(String url, Map<String, Object> paramMap, String method) {
        ...
        return new Request.Builder().method(method, requestBody).url(url).addHeader("cookie", "sss").build();
    }
    ...
    private static Object newHttpClient(Request request, int type, int timeout, List<Interceptor> interceptorList) throws Exception {
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                throw new CustomException("" + response.code(), "newHttpClient has response error!reposne code is " + response.code());
            }
        } catch (IllegalStateException e) {
            LOG.error("http has illegal state exception. " + e.getMessage(), e);
            throw new CustomException("" + 100, "newHttpClient IllegalStateException");
    ...
    public static Response httpClientFormPostReturnAsMap(String url, Map<String, Object> paramMap, int timeout) throws Exception {
    ...
    * @throws Exception
    */
    public static String httpClientGetReturnAsString(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
    ...
    */
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> httpClientGetReturnAsMap(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
        Request request = buildGetUrlEndConnetorParam(url, paramMap);
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> httpClientJsonPostReturnAsMap(String url, String jsonString, int timeout, List<Interceptor> interceptorList) throws Exception {
     ...
     * @return
     */
    public static String httpClientJsonPostReturnAsString(String url, String jsonString, int timeout, List<Interceptor> interceptorList) throws Exception {
        Request request = buildJsonParam(url, jsonString);
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> httpClientJsonPostReturnAsMap(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
     ...
     * @return
     */
    public static String httpClientJsonPostReturnAsString(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
        Request request = buildJsonParam(url, paramMap);
        return (String) newHttpClient(request, TEXT_TYPE, timeout, interceptorList);
    }
     ...
     * @return
     */
    public static String httpClientJsonPutReturnAsString(String url, String jsonString, int timeout, List<Interceptor> interceptorList) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> httpClientJsonPutReturnAsString(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
     ...
     * @return
     */
    public static String httpClientPostReturnJson(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
        Request request = buildPostUrlEndConnetorParam(url, paramMap);
        return (String) newHttpClient(request, TEXT_TYPE, timeout, interceptorList);
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> httpClientPostFormReturnMap(String url, Map<String, Object> paramMap, int timeout, List<Interceptor> interceptorList) throws Exception {
        Request request = buildPostUrlEndConnetorParam(url, paramMap);
        Object object = newHttpClient(request, MAP_TYPE, timeout, interceptorList);
        return object != null ? (Map<String, Object>) object : null;
     ...
     * @throws Exception
     */
    public static String clientPostXmlRetTxt(String url, String xml, int timeout, List<Interceptor> interceptorList) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        try {
            Map<String, Object> ret = httpClientPostFormReturnMap("http://172.30.0.129:18080/fspf-rcmms/service/riskControlCheck.htm", map, 10, null);
